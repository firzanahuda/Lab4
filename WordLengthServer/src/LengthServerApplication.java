 ...
 * The server generates length of word in a string.
...
public class LengthServerApplication {
	...
	public static void main(String[] args) throws IOException {
		...
		LengthServerFrame serverFrame = new LengthServerFrame();
		...
		WordLengthGenerator lengthGenerator = new WordLengthGenerator();
		...
		while (true) {
			...
			String currentDate = lengthGenerator.getWordLength();
