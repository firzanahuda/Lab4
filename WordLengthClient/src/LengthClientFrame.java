 ...
 * It display the number of word retrieve from the server.
 * 
 * @author firzanahuda
 *
 */

public class LengthClientFrame extends JFrame{
	...
	/**
	 * This method update the word count on the frame
	 * 
	 */
	public void updateWordCount (String wordCount) {

		this.lblWordCount.setText(wordCount);
	...
	private JPanel getServerDatePanel(Font font) {
		...
		JPanel panel = new JPanel();
		JLabel lblWord = new JLabel ("Word Count (from Server) : ");
